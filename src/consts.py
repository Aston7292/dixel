...
BLACK: Final[list[int]] = [0, 0, 0]
WHITE: Final[list[int]] = [255, 255, 255]
LIGHT_GRAY: Final[list[int]] = [85, 85, 85]
DARK_GRAY: Final[list[int]] = [75, 75, 75]

EMPTY_TILE_IMG: pg.Surface = pg.Surface((2, 2))
for y in range(2):
    for x in range(2):
        pixel_color: list[int] = DARK_GRAY if (x + y) % 2 else LIGHT_GRAY
