...
class TestUtils(TestCase):
    ...
    def test_try_create_file_argv(self, mock_print: mock.Mock, mock_path_touch: mock.Mock) -> None:
        """Tests the try_create_file_argv function, mocks the print and the Path.touch methods."""

        img_file_obj: Path = Path("a.png")

        self.assertFalse(try_create_file_argv(img_file_obj, ""))
    ...
    def test_try_create_dir_argv(self, mock_print: mock.Mock, mock_path_mkdir: mock.Mock) -> None:
        """Tests the try_create_dir_argv function, mocks the print and the Path.mkdir methods."""

        img_file_obj: Path = Path("a", "a.png")

        self.assertFalse(try_create_dir_argv(img_file_obj, ""))
        mock_print.assert_called_once()
    ...
    def test_handle_argv(self, mock_print: mock.Mock, mock_isreserved: mock.Mock) -> None:
        """Tests the handle_argv function, mocks the print and os.path.isreserved functions."""
        ...
        mock_isreserved.assert_called_once_with("a.png")
    ...
    def test_ask_save_to_file(self, mock_ask_save_as_file_name: mock.Mock) -> None:
        """Test the ask_save_to_file function, mocks the filedialog.asksaveasfilename function."""
